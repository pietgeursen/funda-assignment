...
function getTopTenAgents ({ request, updateProgress, withGardens }, cb) {
  ...
  pull(
    // This stream emits what page number we should get.
    pageNumberStream,
    ...
    // We notify of our current progress if the function has been passed to us. Again, this is another side effect.
    pull.through(body => {
